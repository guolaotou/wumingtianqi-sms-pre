...
func (smsSdk *SmsSdk)SmsSdk(TemplateParamSet []string, TemplateID string, PhoneNumberSet string) {
	...
	* 你可以直接查询SDK源码确定接口有哪些属性可以设置
	...
	request.SmsSdkAppid = common.StringPtr(smsSdk.SmsSdkAppId)
	/* 短信签名内容: 使用 UTF-8 编码，必须填写已审核通过的签名，签名信息可登录 [短信控制台] 查看 */
	request.Sign = common.StringPtr(smsSdk.Sign)
	...
	/* 模板参数: 若无模板参数，则设置为空*/
	//request.TemplateParamSet = common.StringPtrs([]string{"0呵呵", "1哈哈"})
	...
	request.PhoneNumberSet = common.StringPtrs([]string{PhoneNumberSet})
